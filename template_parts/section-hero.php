...
<!--             src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/bg_author.png'); ?><!--"-->
<!--             loading="lazy"/>-->
<!---->
<!--    </div>-->
<!--    <div class="container">-->
...
<!--                     src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/Author.png'); ?><!--"-->
<!--                     loading="lazy"/>-->
<!--            </div>-->
<!---->
<!--            <div class="author-section__inner">-->
<!--                <h1 class="h1">Анастасія Курінська</h1>-->
<!---->
<!--                <p>Пишу про сучасне мистецтво. Закінчила КНУ за спеціальністю "Прикладна математика" (2020-2024) та вивчаю "Мистецтвознавство. Теорія та історія мистецтв" (2022-2026) у НАОМА. Пройшла курси Litosvita "Культурна журналістика та блогінг". </p>-->
<!---->
<!--                <span class="author-section__info">-->
<!--                     <i class="sprite">-->
<!--                                        --><?php //sprite(16, 16, 'article') ?>
<!--                                    </i>-->
<!--                    11 статей-->
<!--                </span>-->
<!--            </div>-->
...
<!--                     src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/image.png'); ?><!--"-->
<!--                     loading="lazy"/>-->
<!---->
...
<!--                             src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/img.png'); ?><!--"-->
<!--                             loading="lazy"/>-->
<!--                    </div>-->
<!---->
...
<!--                                     src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/img2.png'); ?><!--"-->
<!--                                     loading="lazy"/>-->
<!--                            </div>-->
<!---->
...
<!--                            <div class="news-card__image">-->
<!--                                <img width="310" height="146"-->
<!--                                     src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/img3.png'); ?><!--"-->
<!--                                     loading="lazy"/>-->
<!--                            </div>-->
<!---->
...
<!--                            <div class="news-card__image">-->
<!--                                <img width="310" height="146"-->
<!--                                     src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/img4.png'); ?><!--"-->
<!--                                     loading="lazy"/>-->
<!--                            </div>-->
<!---->
...
<!--                                         src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/book1.png'); ?><!--"-->
<!--                                         loading="lazy"/>-->
<!--                                </div>-->
<!---->
...
<!--                                <div class="book-card__image">-->
<!--                                    <img width="186" height="260"-->
<!--                                         src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/book2.png'); ?><!--"-->
<!--                                         loading="lazy"/>-->
<!--                                </div>-->
<!---->
<!--                                <div class="book-card__box">-->
...
<!--                                <div class="book-card__image">-->
<!--                                    <img width="186" height="260"-->
<!--                                         src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/book3.png'); ?><!--"-->
<!--                                         loading="lazy"/>-->
<!--                                </div>-->
<!---->
<!--                                <div class="book-card__box">-->
...
<!--                                <div class="book-card__image">-->
<!--                                    <img width="186" height="260"-->
<!--                                         src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/book4.png'); ?><!--"-->
<!--                                         loading="lazy"/>-->
<!--                                </div>-->
<!---->
<!--                                <div class="book-card__box">-->
...
<!--                                <div class="book-card__image">-->
<!--                                    <img width="186" height="260"-->
<!--                                         src="--><?php //= esc_url(get_template_directory_uri() . '/assets/img/book5.png'); ?><!--"-->
<!--                                         loading="lazy"/>-->
<!--                                </div>-->
<!---->
<!--                                <div class="book-card__box">-->
